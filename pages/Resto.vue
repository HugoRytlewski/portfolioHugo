        ...
        <div class="mt-8 md:mt-10 w-3/5 gap-8 md:flex">
          ...
          <div>
            <span class="text-2xl text-white"
              >Resto.fr est un projet de référencement de restaurants. C'est un
              projet sur lequel j'ai travaillé pendant mon BTS SIO.</span
            >
          </div>
        </div>
        <div class="mt-8 md:mt-10 w-3/5 gap-8 md:flex">
          ...
          <div class="flex flex-col mt-4 md:mt-0">
            <span class="text-2xl text-white text-left md:text-center"
              >Ajout de la fonctionnalité "Espace de recherche".</span
            >
            <br />
            <span class="text-2xl text-white text-left md:text-center"
              >Ajout de la fonctionnalité "Ajout aux favoris".
            </span>
          </div>
          <br />
          <div class="flex flex-col">
            <span class="text-2xl text-white text-left md:text-center"
              >Ajout de la fonctionnalité "Commentaires".
            </span>
            <br />
            <span class="text-2xl text-white text-left md:text-center"
              >Ajout de la fonctionnalité "Connexion".</span
            >
          </div>
        </div>
