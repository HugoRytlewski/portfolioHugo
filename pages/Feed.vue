        ...
        <div class="mt-8 md:mt-10 w-3/5 gap-8 md:flex">
          ...
          <div>
            <span class="text-2xl text-white"
              >Feed Tracker est un projet personnel qui montre la réalisation
              d'un site de veille informatique.</span
            >
          </div>
        </div>
        <div class="mt-8 md:mt-10 w-3/5 gap-8 md:flex">
          ...
          <div class="flex flex-col mt-4 md:mt-0">
            <span class="text-2xl text-white text-left md:text-center"
              >Ajout de la fonction : Fetcher les informations des flux rss afin
              de construire des articles .</span
            >
          </div>
          <br />
          <div class="flex flex-col">
            <span class="text-2xl text-white text-left md:text-center"
              >Ajout d'affichage : cela permet à l'utilisateur de voir les
              articles .
            </span>
          </div>
        </div>
