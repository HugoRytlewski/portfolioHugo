            ...
            >
              ...
              <div class="flex gap-2">
                ...
                <a
                  ...
                  href="https://portfolio-new-gules.vercel.app"
                  target="_blank"
                  >ici
                </a>
                <a
                  class="text-white text-xl md:text-2xl"
                  href="https://feed-beryl.vercel.app"
                  target="_blank"
                  >!
                </a>
              </div>
            ...
            <div class="mt-8 md:mt-10 w-3/5 gap-8 md:flex">
              ...
              <div>
                <span class="text-2xl text-white"
                  >Creation d'un nouveau Portfolio avec un nouveau design</span
                >
              </div>
            </div>
            <div class="mt-8 md:mt-10 w-3/5 gap-8 md:flex">
              ...
              <div class="flex flex-col mt-4 md:mt-0">
                <span class="text-2xl text-white text-left md:text-center"
                  >Toujours en cours de developpement</span
                >
              </div>
              <br />
              <div class="flex flex-col">
                <span class="text-2xl text-white text-left md:text-center"
                  >Montrer mes nouvelles comptences en developpement web
                </span>
              </div>
            </div>
            <div class="h-16 mt-8 md:mt-10 w-3/5 gap-10 md:flex ">
              ...
              >
                ...
                <div class="flex flex-col items-center w-10 ">
                    ...
                    />
                    <Transition>
                      <span v-if="ShowCss" class="text-white text-xl mt-2 ">Tailwind</span>
                    </Transition>
                  </div>
              </div>
            </div>
