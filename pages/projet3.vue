...
<div class="flex flex-col min-h-screen">
  ...
  <div class="flex-grow">
    <div class="mt-28 flex flex-col justify-center items-center">
      <img class="w-2/5 h-3/6 rounded-xl md:w-auto bg-white p-6" src="~/assets/img/meteo.ico " alt="collection-logo">
      <div class="mt-10 md:mt-28 w-3/5 border-b-2 pb-4 border-white md:flex justify-between ">
        <h1 class="text-4xl text-white">Météo </h1>
      ...
      <div class="mt-8 md:mt-10 w-3/5 gap-8 md:flex">
        ...
        <div>
          ...
          <span class="text-2xl text-white">Météo est un projet personnel qui montre la réalisation d'un site de météo.</span>
      ...
      <div class="mt-8 md:mt-10 w-3/5 gap-8 md:flex">
        ...
        <div class="flex flex-col mt-4 md:mt-0">
          <span class="text-2xl text-white md:text-center ">Ajout de barre de recherche pour chercher une ville:  elle permet à l'utilisateur de choisir une ville pour consulter sa météo .</span>

        </div>
        <br>
        <div class="flex flex-col">

        <span class="text-2xl text-white text-left md:text-center">Ajout d'information supplémentaire : cela permet à l'utilisateur de voir l'humidite , la temperature minimum et maximum. </span>
      </div>
      </div>
    ...
    <div  class="relative w-full" >
      <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
        <div class=" duration-300 ease-in-out">
          <img src="~/assets/img/appmeteo.png" class="absolute block max-w-full h-auto -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="screen-collection">
        </div>
      </div>
