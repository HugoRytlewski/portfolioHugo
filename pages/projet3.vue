    ...
    <div class="mt-28 flex flex-col justify-center items-center">
      ...
      <div class="mt-10 md:mt-28 w-3/5 border-b-2 pb-4 border-white md:flex justify-between ">
        ...
        <div class="flex gap-2">
          <a class="text-yellow-300 text-xl md:text-2xl" href="">Consulter le site </a>

          <a class="text-yellow-300 text-xl md:text-2xl underline underline-offset-8" href="https://animationtest.vercel.app">ici </a>
          <a class="text-yellow-300 text-xl md:text-2xl " href="https://animationtest.vercel.app">! </a>
        </div>
      ...
      <div class="mt-8 md:mt-10 w-3/5 gap-8 md:flex">
        <h1 class="text-3xl text-yellow-300">Résumé</h1>
        <div>
          
          <span class="text-2xl text-white">Collection est un projet personnel qui montre la réalisation d'un site de mise en avant d'une collection.</span>
  

        </div>
      </div>
      <div class="mt-8 md:mt-10 w-3/5 gap-8 md:flex">
        <h1 class="text-3xl text-yellow-300">Mission(s)</h1>
        <div class="flex flex-col mt-4 md:mt-0">
          <span class="text-2xl text-white text-left md:text-center ">Ajout de photos de la collection : elle permet à l'utilisateur de visualiser la collection.</span>

        </div>
        <br>
        <div class="flex flex-col">

        <span class="text-2xl text-white text-left md:text-center">Ajout d'animation sur la première page : cela permet à l'utilisateur d'avoir une meilleure expérience sur le site. </span>
      </div>
      </div>
      <div class="h-16 mt-8 md:mt-10 w-3/5 gap-10 md:flex ">
        <h1 class="text-3xl text-yellow-300">Technologies</h1>
