...
<template>
  ...
  <div class="flex flex-col min-h-screen">
    ...
    <div class="flex-grow">
      <div class="mt-28 md:mt-28 flex flex-col justify-center items-center">
        <img class="w-2/5 h-3/6 rounded-lg md:w-auto" src="~/assets/img/logo.png" alt="resto">

        <div class="mt-12 md:mt-28 w-3/5 border-b-2 pb-4 border-white">
          <h1 class="text-4xl text-red-500">RESTO.FR</h1>
        </div>
        <div class="mt-8 md:mt-10 w-3/5 gap-8 md:flex">
          <h1 class="text-3xl text-red-500">Résumé</h1>
          <div>
          ...
          <div class="flex flex-col mt-4 md:mt-0">
            ...
            <span class="text-2xl text-white text-left md:text-center">Ajout de la fonctionnalité "Espace de recherche".</span>
            <br>
            <span class="text-2xl text-white text-left md:text-center">Ajout de la fonctionnalité "Ajout aux favoris". </span>
          </div>
          <br>
          <div class="flex flex-col">
          <span class="text-2xl text-white text-left md:text-center">Ajout de la fonctionnalité "Commentaires". </span>
          <br>
          <span class="text-2xl text-white text-left md:text-center">Ajout de la fonctionnalité "Connexion".</span>
        </div>
        </div>
